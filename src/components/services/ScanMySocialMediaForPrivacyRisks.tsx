                ...
                <div className="space-y-5">
                    <div className="space-y-3">
                        <h3 className="text-sm font-medium text-foreground pb-2 border-b border-border/50">
                            Platforms to Scan <span className="text-muted-foreground/80">*</span>
                        </h3>
                        ...
                        {selectedPlatforms.length === 0 && (
                            <p className="text-xs text-muted-foreground">Please select at least one platform</p>
                        )}
                    </div>

                    <div className="space-y-3">
                        <h3 className="text-sm font-medium text-foreground pb-2 border-b border-border/50">
                            Profile URLs <span className="text-muted-foreground/80">*</span>
                        </h3>
                        <div className="space-y-2">
                            {profileUrls.map((url, index) => (
                                <div key={index} className="flex gap-2 items-center">
                                    <Input
                                        ...
                                        className="flex-1 border-border focus:border-border/80"
                                        required={index === 0}
                                    />
                            ...
                            <Button
                                ...
                                variant="outline"
                                onClick={addUrlField}
                                className="w-full border-dashed border-border text-muted-foreground hover:border-border/80"
                            >
                    ...
                    <div className="space-y-3">
                        <h3 className="text-sm font-medium text-foreground pb-2 border-b border-border/50">
                            Specific Concerns <span className="text-muted-foreground/80">(Optional)</span>
                        </h3>
