        ...
        <div className="space-y-5">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="awarenessSubject" className="text-sm font-medium text-foreground/80">
                  Subject <span className="text-muted-foreground/80">*</span>
                </Label>
                <select
                  id="awarenessSubject"
                  name="awarenessSubject"
                  required
                  className="w-full border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary bg-card text-foreground/80"
                >
              ...
              <div className="space-y-2">
                <Label htmlFor="awarenessPlace" className="text-sm font-medium text-foreground/80">
                  Location <span className="text-muted-foreground/80">*</span>
                </Label>
                <select
                  id="awarenessPlace"
                  name="awarenessPlace"
              ...
              <div className="space-y-2">
                <Label htmlFor="audienceNumber" className="text-sm font-medium text-foreground/80">
                  Number of Attendees <span className="text-muted-foreground/80">*</span>
                </Label>
                <select
                  id="audienceNumber"
                  name="audienceNumber"
              ...
              <div className="space-y-2">
                <Label htmlFor="audienceType" className="text-sm font-medium text-foreground/80">
                  Audience Type <span className="text-muted-foreground/80">*</span>
                </Label>
                <select
                  id="audienceType"
                  name="audienceType"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                <Label htmlFor="preferredDate" className="text-sm font-medium text-foreground/80">
                  Date <span className="text-muted-foreground/80">*</span>
                </Label>
                <Input
                  type="date"
                  id="preferredDate"
                  ...
                  className="border-border focus:border-primary/50 focus:ring-primary rounded-lg"
                />
              </div>

              <div className="space-y-2">
                <Label htmlFor="preferredTime" className="text-sm font-medium text-foreground/80">
                  Time <span className="text-muted-foreground/80">*</span>
                </Label>
                <Input
                  type="time"
                  id="preferredTime"
              ...
              <div className="space-y-2">
                <Label htmlFor="trainingDuration" className="text-sm font-medium text-foreground/80">
                  Duration <span className="text-muted-foreground/80">*</span>
                </Label>
                <select
                  id="trainingDuration"
          ...
          <div className="space-y-2">
            <Label htmlFor="trainingObjectives" className="text-sm font-medium text-foreground/80">
              Training Objectives <span className="text-muted-foreground/80">*</span>
            </Label>
            <Textarea
              id="trainingObjectives"
              name="trainingObjectives"
              placeholder="Describe the specific goals and learning outcomes you want to achieve"
              className="min-h-[80px] resize-none border-border focus:border-primary/50 focus:ring-primary rounded-lg"
              rows={3}
              required
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className="min-h-[60px] resize-none border-border focus:border-primary/50 focus:ring-primary rounded-lg"
              rows={2}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="space-y-2">
                <Label htmlFor="organizationName" className="text-sm font-medium text-foreground/80">
                  Organization Name <span className="text-muted-foreground/80">*</span>
                </Label>
                <Input
                  id="organizationName"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="contactPhone" className="text-sm font-medium text-foreground/80">
                    Contact Phone <span className="text-muted-foreground/80">*</span>
                  </Label>
                  <Input
                    id="contactPhone"
                    name="contactPhone"
