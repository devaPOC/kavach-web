					...
					{sidebarCollapsed ? (
						...
						<>
							<div className="flex items-center gap-3">
								<div className="h-9 w-9 bg-sidebar-primary rounded-xl flex items-center justify-center shadow-sm">
									<Shield className="h-5 w-5 text-sidebar-primary-foreground" />
								</div>
								<div className="text-xl font-bold tracking-tight text-sidebar-foreground uppercase">
									Kavach
								</div>
								<span className="text-base font-semibold text-sidebar-foreground/80 tracking-tight">Super Admin</span>
							</div>
							<button
								onClick={onSidebarCollapse}
