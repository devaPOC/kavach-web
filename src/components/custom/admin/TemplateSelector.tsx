            ...
            {selectedTemplate && (
              <Card className="bg-primary/10 border-primary/50">
                <CardContent className="pt-4">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h4 className="font-medium text-primary mb-1">Selected Template</h4>
                      <p className="text-sm text-primary">{selectedTemplate.name}</p>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <p className="font-medium text-foreground/80">Time Limit</p>
                      <p className="text-muted-foreground">{previewTemplate.templateConfig.timeLimitMinutes} minutes</p>
                    </div>
                    <div>
                      <p className="font-medium text-foreground/80">Max Attempts</p>
                      <p className="text-muted-foreground">{previewTemplate.templateConfig.maxAttempts}</p>
                    </div>
                    <div>
                      <p className="font-medium text-foreground/80">Language</p>
                      <p className="text-muted-foreground">
                        {previewTemplate.templateConfig.language === 'ar' ? 'Arabic' : 'English'}
                      </p>
                    </div>
                    <div>
                      <p className="font-medium text-foreground/80">Default Questions</p>
                      <p className="text-muted-foreground">{previewTemplate.templateConfig.defaultQuestionCount}</p>
                    </div>
                  </div>
                  ...
                  <div>
                    <p className="font-medium text-foreground/80 mb-2">Question Types</p>
